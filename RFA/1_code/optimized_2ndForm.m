...
% Segunda Forma dos Polinômios Interpoladores
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
form = '2nd';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fun = @(x) fiterror_2ndForm(x,H,M,k,kk);
[Bf,fminopt] = fminsearch(fun,Bini,options);
[~,Fc,kFc,C] = fiterror_2ndForm(Bf,H,M,k,kk);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
addpath('figures');
dir = [fileparts(pwd),filesep,'3_output/optimized_2ndForm/' num2str(Np) '_poles/'];
figures_tf
...
filename = [fileparts(pwd),filesep,...
    sprintf('2_pipeline/optimized_2ndForm/%s_poles',num2str(Np))];
